...
The Model Context Protocol (MCP) enables Perseus to expose platform capabilities to AI agents in a standardized way. This integration allows agents like [[08-Agent-Architecture|Nanobot]] to interact with the platform using a unified tool interface.
